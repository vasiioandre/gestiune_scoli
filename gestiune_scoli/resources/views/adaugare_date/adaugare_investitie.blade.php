...
@section('content')
    ...
    <section id="adaugare_cladire" class="section appear clearfix">
        <div class="container">
            ...
            <div class="row mar-bot40">
                <div class="col-md-offset-3 col-md-6">
                    <div class="section-header">
                        <h1 class="section-heading animated" data-animation="bounceInUp">Adauga investitie</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="cform">
                <form method="POST" action="{{ route('adaugare_investitie.post') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        <label for="authorization" class="col-sm-2 col-form-label col-md-offset-2 text-md-right">{{ __('Autorizatie') }}</label>

                        <div class="col-md-5">
                            {!! Form::file('authorization', array('class' => 'form-control')) !!}
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="authorization" class="col-sm-2 col-form-label col-md-offset-2 text-md-right">{{ __('Proiect') }}</label>

                        <div class="col-md-5">
                            {!! Form::file('project', array('class' => 'form-control')) !!}
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="authorization" class="col-sm-2 col-form-label col-md-offset-2 text-md-right">{{ __('Receptie') }}</label>
